...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user">
            ...
            <div>
                <p class="app-sidebar__user-name">{{ Auth::user()->nama_lengkap}}</p>
        ...
        <ul class="app-menu">
            ...
            <br>
            <li>
                <a class="app-menu__item {{ Route::is('kegiatan_mahasiswa') ? 'active' : '' }}" href="{{ route('kegiatan_mahasiswa') }}">
                    <i class="app-menu__icon bi bi-award"></i><span class="app-menu__label">Manajemen Kegiatan</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ Route::is('prestasi_mahasiswa') ? 'active' : '' }}" href="{{ route('prestasi_mahasiswa') }}">
