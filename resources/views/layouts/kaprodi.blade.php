    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li>
                ...
                <a class="app-menu__item {{ Route::is('kaprodi.index') ? 'active' : '' }}" href="{{ route('kaprodi.index') }}">
                    <i class="app-menu__icon bi bi-speedometer"></i><span class="app-menu__label">Dashboard</span>
                </a>
            </li>
            <br>
            <li>
                <a class="app-menu__item {{ Route::is('kegiatan_mhs') ? 'active' : '' }}" href="{{ route('kegiatan_mhs') }}">
                    <i class="app-menu__icon bi bi-award"></i><span class="app-menu__label">Kegiatan Mahasiswa</span>
                </a>
            </li>
        </ul>
    </aside>
