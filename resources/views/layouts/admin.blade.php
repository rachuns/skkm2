...
<body class="app sidebar-mini">
    ...
    <header class="app-header">
        <a class="app-header__logo topic" href="/"
            ...
            <img style="width:150px;height:50px" src="{{ asset('img/sireka.png') }}" alt="SIREKA Logo" class="navbar-logo">
        </a>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li>
                <a class="app-menu__item {{ Route::is('admin') ? 'active' : '' }}" href="/admin">
                    <i class="app-menu__icon bi bi-speedometer"></i><span class="app-menu__label">Dashboard</span>
                </a>
            </li>
            <br>
            <li>
                <a class="app-menu__item {{ Route::is('mahasiswa') ? 'active' : '' }}" href="/mahasiswa">
                    <i class="app-menu__icon bi bi-people"></i><span class="app-menu__label">Manajemen Mahasiswa</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ Route::is('fakultas') ? 'active' : '' }}" href="/fakultas">
                    <i class="app-menu__icon bi bi-people"></i><span class="app-menu__label">Manajemen Fakultas</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ Route::is('jurusan') ? 'active' : '' }}" href="/jurusan">
                    <i class="app-menu__icon bi bi-people"></i><span class="app-menu__label">Manajemen Jurusan</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ Route::is('kegiatan') ? 'active' : '' }}" href="/kegiatan">
                    <i class="app-menu__icon bi bi-award"></i><span class="app-menu__label">Manajemen Kegiatan</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ Route::is('jenis') ? 'active' : '' }}" href="/jenis">
                    <i class="app-menu__icon bi bi-award"></i><span class="app-menu__label">Jenis Kegiatan</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ Route::is('tingkat') ? 'active' : '' }}" href="/tingkat">
                    <i class="app-menu__icon bi bi-award"></i><span class="app-menu__label">Tingkat Kegiatan</span>
                </a>
            </li>
        </ul>
    </aside>
