...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.jsdelivr.net/nim/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    <title>Login SKKM Credify</title>
    ...
    <section class="login-content">
        <div class="logo">
            <h1
                ...
                <a href="/" style="color: white; text-decoration: none" ><strong><span class="topic"><i class="bi-back"></i> CREDIFY</span></strong></h1></a>
        </div>
        @if (session('failed'))
        ...
        <div class="login-box">
            <form class="login-form" action="{{ route('login.process') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="username" value="{{ old('nim') }}"
                        class="form-control @error('nim') is-invalid @enderror"
                        placeholder="Masukkan NIM / NIDN yang valid" autofocus>
                    @error('username')
